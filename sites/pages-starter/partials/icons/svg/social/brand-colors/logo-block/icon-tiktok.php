...
<svg class="h-6 w-6 svg-icon tiktok-icon" style="enable-background:new 0 0 64 64;" viewBox="0 0 64 64" aria-hidden="true">
    <style type="text/css">
	.st0{fill:#4267B2;}
